...
KNOWN_TAGS = {
    ...
    "minecraft:acacia_logs", "minecraft:birch_logs", "minecraft:cherry_logs",
    "minecraft:crimson_stems", "minecraft:dark_oak_logs", "minecraft:jungle_logs",
    "minecraft:oak_logs", "minecraft:spruce_logs", "minecraft:warped_stems",
    "minecraft:logs", "minecraft:small_flowers", "minecraft:wooden_slabs", "minecraft:wool",
    "minecraft:bamboo_blocks", "minecraft:mangrove_logs", "minecraft:meat", "minecraft:music_discs",
